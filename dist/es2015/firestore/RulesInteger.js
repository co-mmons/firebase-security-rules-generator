...
class RulesInteger extends RulesValue_1.RulesValue {
    gt(other) {
        return new RulesBoolean_1.RulesBoolean(RulesNumber_1.gtExpression(this, other));
    }
    gte(other) {
        return new RulesBoolean_1.RulesBoolean(RulesNumber_1.gteExpression(this, other));
    }
}
