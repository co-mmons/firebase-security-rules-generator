...
function whenTrue(trueExpression, whenTrueValue) {
    if (whenTrueValue instanceof RulesExpression_1.RulesExpression) {
        return new RulesValue_1.RulesValue(new RulesExpression_1.RulesExpression(RulesExpression_1.RulesExpression.l `(`, trueExpression, RulesExpression_1.RulesExpression.l `) ? (`, whenTrueValue, RulesExpression_1.RulesExpression.l `) : null`));
    }
